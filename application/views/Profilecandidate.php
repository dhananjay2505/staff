...
<div class="common_box mt_20 float-left gradient_bg pb_30 pt_30">
    ...
    <span class="primery_title float-left text-white w-100">Stela Maxwell</span>
    <div class="text-white mt_10 float-left w-100">
        <span class="mr_10"><span class="icon_set icon-wall-clock mr_10"></span>stelamaxwell@gmail.com</span> 
        <span class="ml_10"><span class="icon_set icon-placeholders-1 mr_10"></span>98435432332</span> 
    </div>
    <div class="text-white mt_10 float-left w-100">
    ...
    <div class="col-md-8 float-left col-12 no-padding">
        <div class="wrapper">
            ...
            <div class="common_box mt_10 float-left mb_30">
                <h1 class="section_title mb_15">Preferences</h1>
                <a href="" class="add_link float-right" data-toggle="modal" data-target="#preferences">Add/Edit </a>
            </div>    
